...
class CustomerServiceTest {
    ...
    lateinit var subject: CustomerService
    ...
    inner class Create {
        ...
        fun `test create`() {
            ...
            val req = CustomerCreateRequestDto(
        ...
        fun `test create with empty values throws exception`() {
            ...
            val req = CustomerCreateRequestNameDto(
                title = Title.NOT_SPECIFIED,
                firstName = "",
                lastName = "",
            )
            ...
            val ex = catchThrowableOfType(
                {
                    subject.create(CustomerCreateRequestDto(name = req))
                },
    ...
    inner class Update {
        ...
        fun `test update does not touch entity when there is nothing to update`() {
            ...
            subject.update(
                customer0().customerId!!,
                CustomerUpdateRequestDto(name = null),
            )
            ...
            val ex = catchThrowableOfType(
                {
                    subject.addAddress(
                        customer0().customerId!!,
                        CustomerAddressCreateRequestDto(
                            zipcode = null,
                            country = null,
                            city = null,
                            addressLine1 = null,
    ...
    inner class AddressGet {
        ...
        fun `test getAddresses`() {
            ...
            val find = subject.getCustomerAddresses(customer0().customerId!!)
