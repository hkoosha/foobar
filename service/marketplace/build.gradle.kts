...
dependencies {
    ...
    implementation("org.flywaydb:flyway-core:${Libraries.flywayPg}")
    implementation("org.flywaydb:flyway-database-postgresql:${Libraries.flywayPg}")
    ...
    runtimeOnly("org.postgresql:postgresql:${Libraries.postgres}") // flyway
