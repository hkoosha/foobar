...
class KafkaConfig {
    ...
    @Qualifier(KafkaDefinitions.PROD_FACTORY__ORDER_REQUEST__STATE_CHANGED)
    @Bean(KafkaDefinitions.PROD_FACTORY__ORDER_REQUEST__STATE_CHANGED)
    ...
    @Bean(KafkaDefinitions.TEMPLATE__ORDER_REQUEST__STATE_CHANGED)
    fun orderRequestStateChangedKafkaTemplate(
        ...
        KafkaTemplate(producerFactory).apply {
            this.defaultTopic = KafkaDefinitions.TOPIC__ORDER_REQUEST__STATE_CHANGED
        }
